...
public class Transaction implements Comparable<Transaction>, CSV {
    ...
    public void setDebit(@NotNull Boolean debit) {this.debit = debit;}
    @NotNull
    public Double getAmount() {return amount;}
    public void setAmount(@NotNull Double amount) {this.amount = amount;}
    @NotNull
    public String getAccID() {return accID;}
    public void setAccID(@NotNull String accID) {this.accID = accID;}
    @NotNull
    public Double getNewTotal() {return newTotal;}
    public void setNewTotal(@NotNull Double newTotal) {this.newTotal = newTotal;}
    @NotNull
    public LocalDate getDate() {return date;}
    public void setDate(@NotNull LocalDate date) {this.date = date;}
    @NotNull
